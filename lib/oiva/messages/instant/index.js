...
module.exports = { instantMessages, maybeInstantSessionSummary }
...
const v2 = [
  sellMsg(v2Specs.casino5),
  sellMsg(v2Specs.casino10),

  cancelMsg(v2Specs.casino5),
  cancelMsg(v2Specs.casino10),

  validationMsg(v2Specs.casino5),
  validationMsg(v2Specs.casino10),
]
...
function maybeInstantSessionSummary(msgs) {
  ...
  return {
    ...
    payloadObject: {
      ...
      transAmount: candidates.reduce((acc, x) => acc + x.transAmount),
      sessionId
    }
  }
}
